    ...
    <>
      ...
      <div className="player">
        ...
        <div className={`slide ${slide===8?'active':''}`} style={{background:'radial-gradient(ellipse at 50% 35%,#1a1a50 0%,#070714 70%)'}}>
          ...
          <h2 className="au !text-white" style={{fontFamily:"'DM Serif Display',serif",fontSize:'2rem',textAlign:'center',marginBottom:'.5rem',color: '#ffffff'}}>Para sempre,<br/>{nome1} & {nome2}</h2>
