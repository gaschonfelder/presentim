...
import type { FallingAnimation } from '@/lib/falling-animation'
...
export default function PresenteClient({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      {(presente as Presente & { falling_animation?: FallingAnimation | null }).falling_animation?.enabled && (
        <FallingParticles
          animation={(presente as Presente & { falling_animation?: FallingAnimation }).falling_animation!}
        />
      )}
